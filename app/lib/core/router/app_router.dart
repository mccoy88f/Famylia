  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (_, __) => const DeadlinesScreen(),
      ),
      GoRoute(
      ...
      GoRoute(
        path: AppRoutes.expenseBalance,
        builder: (_, __) => const ExpenseBalanceScreen(),
      ),
      GoRoute(
